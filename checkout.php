...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      <a href="cart.php" class="hero-btn">view cart</a>
   </div>
   ...
   <div class="user-info">
      ...
      <input type="submit" value="place order" class="hero-btn <?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%;" name="submit">
   </div>
